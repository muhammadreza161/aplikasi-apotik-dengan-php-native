...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-header">
            <a href="form_obat.php" class="btn btn-success pull-left" method="post">
                      <i class="fa fa-plus">Tambahkan Obat</i></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  ?>
    ...
    echo "<td><a href='detail_obat_staff.php?id_obat=".$data['id_obat']."' class='btn btn-primary'>Detail</a>";
      echo "</tr>";
  }
  ?>
                </tbody>
