  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="obat_staff.php"> <span>Lihat Daftar Obat</span></a></li>
        <li><a href="pesanan_staff.php"> <span>Lihat Daftar Pesanan</span></a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="simpan_obat.php" enctype="multipart/form-data" role="form">
              <div class="box-body"> 
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Id Obat" name="id_obat" />
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Nama Obat" name="nama_obat" />
                </div>
                <div class="form-group">
                <select class="form-control select2" placeholder="Jenis Obat" style="width: 100%;" name="jenis_obat">
                  <option selected="selected">Jenis Obat</option>
