      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
           <form method="post" action="ubah_obat.php?NO=<?php echo $NO; ?>" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                <select class="form-control select2" placeholder="Jenis Obat" style="width: 100%;" name="jenis_obat" value="<?php echo $data['jenis_obat']; ?>">
                  <option selected="selected" ><?php echo $data['jenis_obat']; ?></option>
