  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="login.php"> <span>Kembali</span></a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Silahkan mendaftar: </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="simpan_daftar.php" enctype="multipart/form-data" role="form">
              <div class="box-body"> 
              <div class="form-group">
                  <input type="text" class="form-control" placeholder="ID Pelanggan" name="id_pelanggan" "/>
                </div>
                <div class="form-group">
