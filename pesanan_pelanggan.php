...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li><a href="index_pelanggan.php"> <span>Beranda</span></a></li>
  ...
  $query = "SELECT * FROM pesanan WHERE id_pesanan='".$NO."'";
  ...
  ?>
    ...
    echo "<td><a href='cetak.php?id_pesanan=".$data['id_pesanan']."' class='btn btn-primary'>Cetak Invoice</a>";
    echo "</tr>";
  }
  ?>
